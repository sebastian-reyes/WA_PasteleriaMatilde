...
public class RealizarPedido extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String pedido = request.getParameter("id");
        String direccion = request.getParameter("direccion");
        String cliente = request.getParameter("cliente");
        List<Detalle_Pedido_Venta> lstdetalle = new DetPdoVta().listarDetallePedido(pedido);

        request.setAttribute("id", pedido);
        request.setAttribute("direccion", direccion);
        request.setAttribute("cliente", cliente);
        request.setAttribute("lstdetalle", lstdetalle);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/Repartidor_RealizarPedido.jsp");
