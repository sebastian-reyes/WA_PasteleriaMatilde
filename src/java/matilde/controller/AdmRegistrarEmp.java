 ...
 * @author Sebastián
 */
@WebServlet(name = "AdmRegistrarEmp", urlPatterns = {"/AdmRegistrarEmp"})
public class AdmRegistrarEmp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AdmRegistrarEmp</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AdmRegistrarEmp at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        resultado = new UsuarioDao().RegistrarEmpleado(objusuario);
