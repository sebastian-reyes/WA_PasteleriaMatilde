...
public class DetallePedido extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Detalle_Pedido_Venta> lstdetalle = new DetPdoVta().listarDetallePedido(pedido);
        request.setAttribute("lstdetalle", lstdetalle);
        RequestDispatcher dispatcher = request.getRequestDispatcher("/Admin_MantClientePedidosDetalle.jsp");
